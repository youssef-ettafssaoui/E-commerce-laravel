				...
				<div class="topbar-menu-area">
					<div class="container">
						<div class="topbar-menu left-menu">
							<ul>
								<li class="menu-item" >
									<a title="IRISI-1" href="#" ><span class="icon label-before fa fa-id-card"></span> IRISI-1</a>
								</li>
							</ul>
						</div>
						<div class="topbar-menu right-menu">
							<ul>
								...
								<li class="menu-item lang-menu menu-item-has-children parent">
									<a title="English" href="#"><span class="img label-before"><img src="assets/images/lang-en.png" alt="lang-en"></span>Anglais<i class="fa fa-angle-down" aria-hidden="true"></i></a>
									<ul class="submenu lang" >
										<li class="menu-item" ><a title="french" href="#"><span class="img label-before"><img src="assets/images/lang-fra.png" alt="lang-fre"></span>Français</a></li>
							
									</ul>
								</li>
								<li class="menu-item menu-item-has-children parent" >
									<a title="Dirham (DH)" href="#">Dirham (DH)<i class="fa fa-angle-down" aria-hidden="true"></i></a>
						...
						<div class="wrap-icon right-section">
							<div class="wrap-icon-section wishlist">
								<a href="#" class="link-direction">
									...
									<div class="left-info">
										<span class="index">0 élément</span>
							...
							<div class="wrap-icon-section minicart">
								<a href="#" class="link-direction">
									...
									<div class="left-info">
										@if(Cart::count() > 0)
											<span class="index">{{Cart::count()}} éléments</span>
										@endif
					...
					<div class="primary-nav-section">
						<div class="container">
							<ul class="nav primary clone-main-menu" id="mercado_main" data-menuname="Main menu" >
								...
								<li class="menu-item">
									<a href="/cart" class="link-term mercado-item-title">Chariot</a>
								</li>
								<li class="menu-item">
									<a href="/checkout" class="link-term mercado-item-title">Caisses</a>
								</li>
								<li class="menu-item">
									<a href="contact-us.html" class="link-term mercado-item-title">contactez-Nous</a>
								</li>																	
							</ul>
						</div>
					</div>
					...
					<ul>
						<li class="fc-info-item">
							...
							<div class="wrap-left-info">
								...
								<p class="fc-desc">Gratuit sur Order de plus de 999 DH </p>
							</div>
						...
						<li class="fc-info-item">
							...
							<div class="wrap-left-info">
								...
								<p class="fc-desc">Assistance 24h/24 et 7j/7</p>
							</div>
				...
				<div class="container">
					...
					<div class="row">
									...
									<div class="wrap-contact-detail">
										<ul>
											<li>
												...
												<p class="contact-txt">112 Boulevard Abdelkrim Al Khattabi, Marrakech 40000</p>
											</li>
											<li>
												<i class="fa fa-phone" aria-hidden="true"></i>
												<p class="contact-txt">(+212) 658142766 - (+212) 652653887</p>
											</li>
											<li>
												<i class="fa fa-envelope" aria-hidden="true"></i>
												<p class="contact-txt">yettafssaoui2@gmail.com /  </p>
											</li>											
										</ul>
									</div>
								</div>
						...
						<div class="col-lg-4 col-sm-4 col-md-4 col-xs-12">
							...
							<div class="wrap-footer-item">
								<h3 class="item-header">Ligne ouvert 24/24 </h3>
								<div class="item-content">
									<div class="wrap-hotline-footer">
										<span class="desc">Appelez-nous sans frais</span>
										<b class="phone-number">(+212) 658142766</b>
										<b class="phone-number">(+212) 652653887</b>
									</div>
								</div>
							</div>
			...
			<div class="coppy-right-box">
				<div class="container">
					<div class="coppy-right-item item-left">
						<p class="coppy-right-text">Copyright © 2021 IRISI-1 Application Web E-Commerce avec Laravel8 </p>
					</div>
