		...
		<div class="container">
			...
			<div class="wrap-breadcrumb">
				<ul>
					...
					<li class="item-link"><span>Notre MacBook</span></li>
				</ul>
			</div>
			<div class="row">
				...
				<div class="col-lg-9 col-md-8 col-sm-8 col-xs-12 main-content-area">
					...
					<div class="wrap-shop-control">
						...
						<h1 class="shop-title">Notre MacBook</h1>
						...
						<div class="wrap-right">
							...
							<div class="change-display-mode">
								...
								<a href="list.html" class="list-mode display-mode"><i class="fa fa-th-list"></i>Lister</a>
							</div>
								...
								<li class="col-lg-4 col-md-6 col-sm-6 col-xs-6 ">
									<div class="product product-style-3 equal-elem ">
										...
										<div class="product-info">
											...
											<a href="#" class="btn add-to-cart" wire:click.prevent="store({{$product->id}},'{{$product->name}}',{{$product->prix_ordinaire}})">Ajouter au panier</a>
										</div>
									</div>
								</li> 
							@endforeach
					...
					<div class="wrap-pagination-info">
						<!-- Importer les données de la base de données et reduire le nombre des display  -->
					{{$products->links()}}
