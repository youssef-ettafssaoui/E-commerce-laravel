			...
			<div class="row">
				...
				<div class="col-lg-9 col-md-8 col-sm-8 col-xs-12 main-content-area">
					<div class="wrap-product-detail">
						...
						<div class="detail-info">
                            ...
                            <div class="wrap-price"><span class="product-price">{{$product->prix_ordinaire}} DH</span></div>
                            <div class="stock-info in-stock">
                                <p class="availability">Disponibilité : <b>{{$product->stock_statut}}</b></p>
                            </div>
                            <div class="quantity">
                            	<span>Quantité :</span>
							...
							<div class="wrap-butons">
								<a href="#" wire:click.prevent="store({{$product->id}},'{{$product->name}}',{{$product->prix_ordinaire}})" class="btn add-to-cart">Ajouter au panier</a>
                                <div class="wrap-btn">
                                    <a href="#" class="btn btn-compare">Comparer Article</a>
                                    <a href="#" class="btn btn-wishlist">Ajout au Souhait</a>
                                </div>
							</div>
						</div>
						<div class="advance-info">
							<div class="tab-control normal">
								...
								<a href="#add_infomation" class="tab-control-item">Informations supplémentaires</a>
				...
				<div class="col-lg-3 col-md-4 col-sm-4 col-xs-12 sitebar">
					...
					<div class="widget mercado-widget widget-product">
						...
						<div class="widget-content">
						    <ul class="products">
                                @foreach ($products_popular as $p_product)  
                                <li class="product-item">
									<div class="product product-widget-style">
										...
										<div class="product-info">
											...
											<div class="wrap-price"><span class="product-price">{{$p_product->prix_ordinaire}} DH</span></div>
										</div>
									</div>
								</li>
                                @endforeach
					...
					<div class="wrap-show-advance-info-box style-1 box-in-site">
						...
						<div class="wrap-products">
							<div class="products slide-carousel owl-carousel style-nav-1 equal-container" data-items="5" data-loop="false" data-nav="true" data-dots="false" data-responsive='{"0":{"items":"1"},"480":{"items":"2"},"768":{"items":"3"},"992":{"items":"3"},"1200":{"items":"5"}}' >
                                @foreach($products_related as $r_product)
                                <div class="product product-style-2 equal-elem ">
									<div class="product-thumnail">
										...
										<div class="wrap-btn">
											<a href="{{ route('product.details', ['slug'=> $r_product->slug]) }}" class="function-link">Aperçu Rapide</a>
										</div>
									</div>
									<div class="product-info">
										<a href="{{ route('product.details', ['slug'=> $r_product->slug]) }}" class="product-name"><span>{{$r_product->name}}</span></a>
										<div class="wrap-price"><span class="product-price">{{$r_product->prix_ordinaire}} DH</span></div>
									</div>
								</div>
